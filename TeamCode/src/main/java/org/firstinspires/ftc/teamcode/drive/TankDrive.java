...
public class TankDrive extends com.acmerobotics.roadrunner.drive.TankDrive {
    ...
    public TankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "flMec");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "blMec");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "brMec");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "frMec");
